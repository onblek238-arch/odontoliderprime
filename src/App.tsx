...
function Doctors() {
  return (
    <section className="section doctors doctors-clean-section" id="doutores">
      <div className="doctors-clean-layout">
        <article className="doctor-clean-card doctor-clean-card-anny">
          <img src={clinicAssets.draAnnyProfissional} alt="Dra. Anny Maia" />

          <div className="doctor-clean-badge">Fundadora da Odonto Líder Prime</div>

          <div className="doctor-clean-info">
            <strong>Dra. Anny Maia</strong>
            <span>Odontologia estética • Unidade I</span>
          </div>
        </article>

        <article className="doctor-clean-card doctor-clean-card-flavio">
          <img src={clinicAssets.drFlavio} alt="Dr. Flávio Rodrigues" />

          <div className="doctor-clean-badge">Responsável técnico</div>
        ...
        <div className="doctor-clean-text">
          <span className="kicker">Excelência integrada</span>

          <p>
            Cuidado clínico, estética e tecnologia em cada detalhe do seu sorriso.
          </p>
        </div>
      </div>
    </section>
