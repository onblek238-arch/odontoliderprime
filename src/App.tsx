...
const clinicAssets = {
  logo: 'https://res.cloudinary.com/dhzbbhahz/image/upload/v1784930890/Design_sem_nome_12_hprexs.png',
  logo2: 'https://res.cloudinary.com/dhzbbhahz/image/upload/v1784930674/ChatGPT_Image_24_de_jul._de_2026_19_04_30_hjir1x.png',
  ...
  drFlavio: 'https://res.cloudinary.com/dhzbbhahz/image/upload/v1784929033/pexels-aleson-padilha-945919991-34104788_wuober.jpg',
 
  draAnnyProfissional: 'https://res.cloudinary.com/dhzbbhahz/image/upload/v1784929033/pexels-julianemonarifotografia-20596945_wlzjxv.jpg',
  ...
  feedback1: 'https://res.cloudinary.com/dhzbbhahz/image/upload/v1784930173/ChatGPT_Image_24_de_jul._de_2026_18_56_08_tsn5q1.png',
  feedback2: 'https://res.cloudinary.com/dhzbbhahz/image/upload/v1784930026/ChatGPT_Image_24_de_jul._de_2026_18_53_45_upkiaj.png',
  feedback3: 'https://res.cloudinary.com/dhzbbhahz/image/upload/v1784929883/ChatGPT_Image_24_de_jul._de_2026_18_51_09_nzoghd.png',

  videoTour: 'https://res.cloudinary.com/dhzbbhahz/video/upload/v1784928728/6763241-hd_1920_1080_25fps_zphbtw.mp4',

};

const whatsappOne = '5581999990000';
const whatsappTwo = '5581999990001';
      ...
      <header className={`prime-nav desktop-navbar-only ${scrolled ? 'prime-nav--scrolled' : ''}`}>
        <button className="brand" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          <span className="brand-mark brand-mark-logo">
            <img src={clinicAssets.logo} alt="Sorriso Prime Odontologia" />
          </span>
          ...
          <motion.div className="mobile-menu" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            >
              <div className="mobile-head">
                <strong>Sorriso Prime Odontologia</strong>
    ...
    <section className="section structure" id="estrutura">
      ...
      <div className="video-stage video-stage-main video-stage-clean">
        ...
        <div>
          ...
          <span>Ambientes reais da Sorriso Prime Odontologia.</span>
  ...
  return (
    <section className="section doctors doctors-hover-section" id="doutores">
      <div className="doctors-hover-heading">
        ...
        <p>Conheça os profissionais à frente da experiência Sorriso Prime Odontologia.</p>
      </div>

      <div className="doctors-hover-grid">
        <article className="doctor-hover-card">
          <img src={clinicAssets.draAnnyProfissional} alt="Dra. Camila Duarte" />

          <div className="doctor-hover-base">
            <strong>Dra. Camila Duarte</strong>
            <span>Odontologia estética • Unidade I</span>
          </div>

          <div className="doctor-hover-info">
            <span className="doctor-hover-badge">Fundadora da Sorriso Prime Odontologia</span>
            <h3>Dra. Camila Duarte</h3>
            <p>
              À frente da Sorriso Prime Odontologia, une experiência, gestão e visão humanizada para elevar o padrão
              de atendimento odontológico em Cidade Modelo.
            </p>

            <div className="doctor-hover-facts">
              <span>17 anos de formação</span>
              <span>15 anos de gestão</span>
              <span>CRO 1234 PE</span>
            </div>
          </div>
        </article>

        <article className="doctor-hover-card">
          <img src={clinicAssets.drFlavio} alt="Dr. Marcos Vieira" />

          <div className="doctor-hover-base">
            <strong>Dr. Marcos Vieira</strong>
            <span>Odontologia estética • Unidade II</span>
          </div>

          <div className="doctor-hover-info">
            <span className="doctor-hover-badge">Responsável técnico</span>
            <h3>Dr. Marcos Vieira</h3>
            <p>
    ...
    <section className="section proof" id="depoimentos">
      <div className="proof-grid">
        ...
        <div className="testimonial-card">
          <p>
            “Graças a Deus e à Dra. Camila, estou super bem. Nenhuma dor, só um leve incômodo na região do dente. Muito
            obrigada, perdi o medo de extração.”
          </p>
          <strong>Paciente Sorriso Prime</strong>
  ...
  return (
    <section className="section units" id="unidades">
      <div className="section-heading">
        ...
        <h2>Duas unidades para atender você em Cidade Modelo.</h2>
      </div>
...
function Footer() {
  return (
    <footer className="footer" id="footer">
      <div>
        <strong>Sorriso Prime Odontologia</strong>
        <p>Centro odontológico premium em Cidade Modelo.</p>
      </div>
