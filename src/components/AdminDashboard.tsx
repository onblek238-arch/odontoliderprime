      ...
      <div className="mx-auto w-full max-w-7xl flex-1 overflow-y-auto p-8">
        ...
        <div className="mb-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { label: 'Confirmados', val: stats.confirmed, icon: CheckCircle, color: 'bg-green-500' },
            { label: 'Total', val: stats.total, icon: BarChart, color: 'bg-brand-900' },
          ].map((s, i) => (
            <motion.div
              key={s.label}
              initial={{ opacity: 0, y: 20 }}
        ...
        <div className="mb-8 flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
          ...
          <div className="flex w-full flex-wrap gap-3 md:w-auto">
            ...
            <div className="flex rounded-full border border-brand-100 bg-white p-1">
