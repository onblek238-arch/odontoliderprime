...
export default function AppointmentModal({ isOpen, onClose }: AppointmentModalProps) {
  ...
  const clinicWhatsApp = formData.unit === 'Unidade II' ? '5581999990001' : '5581999990000';

  const editCancelWhatsAppMessage = encodeURIComponent(
    `Olá! Fiz uma solicitação de avaliação pelo site da Sorriso Prime Odontologia e preciso editar ou cancelar meu agendamento.`
  );

  const whatsappMessage = encodeURIComponent(
    `Olá! Fiz uma solicitação de avaliação gratuita pelo site da Sorriso Prime Odontologia.\n\n` +
              ...
              {units.map((u) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm opacity-60">Cidade Modelo - Pernambuco</div>
                  </div>
